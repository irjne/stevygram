...
exports.addChat = function (name, description, users) {
    var obj = {
        chats: Array()
    };
    (function () { return __awaiter(void 0, void 0, void 0, function () {
        var readFile, chats, json, writeFile, file, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
...
exports.changeInfoByChatId = function (id, name, description) {
    ...
    (function () { return __awaiter(void 0, void 0, void 0, function () {
        var readFile, chats, i, json, writeFile, file, err_8;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
...
exports.changeUserByPhone = function (phone, nickname, name, surname) {
    var obj = {
        users: Array()
    };
    (function () { return __awaiter(void 0, void 0, void 0, function () {
        var readFile, chats, i, json, writeFile, file, err_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
...
exports.removeChatById = function (id) {
    ...
    (function () { return __awaiter(void 0, void 0, void 0, function () {
        var readFile, chats, i, json, writeFile, file, err_10;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
...
exports.removeUserByPhone = function (phone) {
    ...
    (function () { return __awaiter(void 0, void 0, void 0, function () {
        var readFile, users, i, json, writeFile, file, err_11;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
